jQuery(document).ready(function($){
	...
	function initTimeline(timelines) {
		timelines.each(function(){
			...
			timelineComponents['timelineWrapper'] = timeline.find('.events-scroll');
	...
	function checkMQ() {
		return window.getComputedStyle(document.querySelector('.h-timeline'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
});
